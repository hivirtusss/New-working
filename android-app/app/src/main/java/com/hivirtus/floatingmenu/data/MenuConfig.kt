...
data class MenuConfig(
    ...
    fun save() {
        runCatching {
            File(CONFIG_PATH).writeText(toIniString())
        }
    }

    fun toIniString(): String = buildString {
        appendLine("# Hivirtus / KC GL compatible config")
        ...
        appendLine("esp_box=${if (toggleEsp) 1 else 0}")
